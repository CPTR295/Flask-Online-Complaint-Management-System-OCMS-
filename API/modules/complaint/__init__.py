...
from modules.complaint.api.category import AddCategoryRestAPI,ListCategoryRestAPI,UpdateCategoryRestAPI,UpdateCategoryNameRestAPI,DeleteCategoryRestAPI
from modules.complaint.api.complaint_details import AddComplaintDetailsRestAPI,ListComplaintDetailsRestAPI,UpdateComplaintDetailsResolutionRestAPI,UpdateComplaintDetailsRestAPI,DeleteComplaintDetailsRestAPI 
...
api.add_resource(DeleteComplaintRestAPI,'/complaint/delete/<id:int>',endpoint='delete_complaint') 
...
api.add_resource(UpdateComplaintDetailsResolutionRestAPI, '/complaint/details/update', endpoint='update_complaint_details')
