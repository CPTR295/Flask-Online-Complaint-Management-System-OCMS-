...
class Complainant(Base):
    ...
    def __init__(self,id,firstname,middlename,lastname,middlename,email,mobile,address,status,zipcode,date_registered):
        self.id = id 
    ...
    def __repr__(self):
        return f'<Customer {self.id} {self.username} {self.middlename} {self.lastname}>'
...
class Administrator(Base):
    ...
    def __init__(self,id,firstname,middlename,lastname,email,mobile,date_registered):
        self.id = id 
        self.firstname = firstname
        self.middlename = middlename
        self.lastname = lastname
...
class Complaint(Base):
    ...
    complaint_type= relatioship('ComplaintType',back_populates='complaints')
    complaint_details = relationship('ComplaintDetails',back_populates='complaints',uselist=False)
...
class Category(Base):
    ...
    id = Column(Integer,Sequence('category_id_seq',increment=1),primary_name=True)
