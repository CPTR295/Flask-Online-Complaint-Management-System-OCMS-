...
app.register_blueprint(home_bp,url_prefix='/ocms')
app.register_blueprint(login_bp,url_prefix='/ocms')
app.register_blueprint(admin_bp,url_prefix='/ocms')
app.register_blueprint(complaint_bp,url_prefix='/ocms')
app.register_blueprint(complainant_bp,url_prefix='/ocms')
